...
public class MainGame extends AppCompatActivity {
    ...
    private ImageButton memoBTN , checklistBTN;
    ...
    private void processView(){
        ...
        checklistBTN = (ImageButton)findViewById(R.id.checklistBTN_GAME);
    }
    private void processControl(){

        memoBTN.setOnClickListener(itemOnClick);
        checklistBTN.setOnClickListener(checklistitemOnClick);
    }
    /*****  Item 按鈕點擊 → 到各Item頁面  *******/
    ...
    private ImageButton.OnClickListener checklistitemOnClick = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
